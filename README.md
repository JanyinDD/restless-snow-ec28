...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/restless-snow-ec28
```

A live public deployment of this template is available at [https://restless-snow-ec28.templates.workers.dev](https://restless-snow-ec28.templates.workers.dev)
